...
/**
 * A rule in one plain sentence, for the owner app, the MCP tools and the docs: the same JSON the
 * engine runs, read back as words. Unknown paths fall back to the raw path so nothing is hidden.
 */
