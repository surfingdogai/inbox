...
export const ROUTE_SCOPES: Readonly<Record<string, readonly string[]>> = {
  ...
  "GET /customers/:id": ["inbox:read"],
  "GET /customers/:id/export": ["inbox:read"],
  "POST /customers/:id/networks-off": ["inbox:write"],
  // Checked again, and enforced whatever `security.enforceScopes` says, by the erasure itself.
  "POST /customers/:id/erase": ["customers:erase"],
  "GET /mail": [READ_SETUP],
...
export const TOOL_SCOPES: Readonly<Record<string, readonly string[]>> = {
  ...
  reply: ["inbox:write"],
  export_customer: ["inbox:read"],
  stop_customer_networks: ["inbox:write"],
