...
The inbox is one codebase with two self-hosting targets and one hosted edition. The core never knows which it is running on. Hosted is not open yet; until it is, self-host.
